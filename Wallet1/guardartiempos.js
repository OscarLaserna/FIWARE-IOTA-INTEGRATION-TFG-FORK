...
function getCurrentTimeInUTCPlusOne() {
    var now = new Date();
    var utcPlusOne = new Date(now.getTime() + 60 * 60 * 1000); // Sumar 1 hora
...
function simulateTruck(routeFile, truckId) {
    return __awaiter(this, void 0, void 0, function () {
        var route, temperature, logFilePath, i, point, currentTime, payload, logEntry, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    logFilePath = path.resolve("truck_".concat(truckId, "_log.txt"));
                ...
                case 1:
                    ...
                    currentTime = getCurrentTimeInUTCPlusOne();
                    payload = "truck|".concat(truckId, "|t|").concat(temperature.toFixed(1), "|ac|").concat(acStates[truckId] ? 'on' : 'off', "|gps|").concat(point[1], ",").concat(point[0], "|time|").concat(currentTime);
                ...
                case 3:
                    _a.sent();
                    logEntry = "Truck ".concat(truckId, " - Time: ").concat(currentTime, "\n");
...
setupUserInput();
launchTrucks(routeFile, 5, 3)["catch"](function (err) { return console.error('Error:', err); });
