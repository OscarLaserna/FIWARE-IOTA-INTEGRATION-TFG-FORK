...
class Account {
     ...
     * @returns The address.
     */
    async generateEd25519Address(options) {
     ...
     */
    async verifyEd25519Signature(signature, message) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
     ...
     */
    async verifySecp256k1EcdsaSignature(signature, message) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
     ...
     */
    async requestFundsFromFaucet(url, address) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
     ...
     */
    async send(params, transactionOptions) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
            name: 'send',
            data: {
                params,
    ...
    async stopParticipating(eventId) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
    ...
    async increaseVotingPower(amount) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
    ...
    async decreaseVotingPower(amount) {
        const response = await this.messageHandler.callAccountMethod(this.meta.index, {
